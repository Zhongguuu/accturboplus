...
class Controller:
    ...
    def read_cluster_statistics_and_update_priorities(self):
        ...
        for index,entry in enumerate(entries):
            ...
            counter_value = self.controller.counter_read('MyIngress.bytes_counter', 0)[index]
        ...
        for cluster in self.cluster_list:
            ...
            # ])
            self.controller.table_modify("MyIngress.cluster_to_prio", 
                                         'set_qid', 
                                         [str(cluster.get_id())],
        ...
        self.controller.counter_reset("MyIngress.bytes_counter")
        print("------------------------------------------------------")
    ...
    def reset_clusters_and_clear_counters(self):
        ...
        if self.init: 
            ...
            self.controller.register_write("MyIngress.cluster1_dst0_min", 140, 255)
            self.controller.register_write("MyIngress.cluster1_dst0_max", 140, 0)
            self.controller.register_write("MyIngress.cluster1_dst1_min", 140, 255)
            self.controller.register_write("MyIngress.cluster1_dst1_max", 140, 0)
            self.controller.register_write("MyIngress.cluster1_dst2_min", 140, 255)
            self.controller.register_write("MyIngress.cluster1_dst2_max", 140, 0)
            self.controller.register_write("MyIngress.cluster1_dst3_min", 140, 255)
            self.controller.register_write("MyIngress.cluster1_dst3_max", 140, 0)
        
            self.controller.register_write("MyIngress.cluster2_dst0_min", 140, 255)
            self.controller.register_write("MyIngress.cluster2_dst0_max", 140, 0)
            self.controller.register_write("MyIngress.cluster2_dst1_min", 140, 255)
            self.controller.register_write("MyIngress.cluster2_dst1_max", 140, 0)
            self.controller.register_write("MyIngress.cluster2_dst2_min", 140, 255)
            self.controller.register_write("MyIngress.cluster2_dst2_max", 140, 0)
            self.controller.register_write("MyIngress.cluster2_dst3_min", 140, 255)
            self.controller.register_write("MyIngress.cluster2_dst3_max", 140, 0)

            self.controller.register_write("MyIngress.cluster3_dst0_min", 140, 255)
            self.controller.register_write("MyIngress.cluster3_dst0_max", 140, 0)
            self.controller.register_write("MyIngress.cluster3_dst1_min", 140, 255)
            self.controller.register_write("MyIngress.cluster3_dst1_max", 140, 0)
            self.controller.register_write("MyIngress.cluster3_dst2_min", 140, 255)
            self.controller.register_write("MyIngress.cluster3_dst2_max", 140, 0)
            self.controller.register_write("MyIngress.cluster3_dst3_min", 140, 255)
            self.controller.register_write("MyIngress.cluster3_dst3_max", 140, 0)

            self.controller.register_write("MyIngress.cluster4_dst0_min", 140, 255)
            self.controller.register_write("MyIngress.cluster4_dst0_max", 140, 0)
            self.controller.register_write("MyIngress.cluster4_dst1_min", 140, 255)
            self.controller.register_write("MyIngress.cluster4_dst1_max", 140, 0)
            self.controller.register_write("MyIngress.cluster4_dst2_min", 140, 255)
            self.controller.register_write("MyIngress.cluster4_dst2_max", 140, 0)
            self.controller.register_write("MyIngress.cluster4_dst3_min", 140, 255)
            self.controller.register_write("MyIngress.cluster4_dst3_max", 140, 0)

        else:
                # We can specified a desired cluster initialization
                self.controller.register_write("MyIngress.cluster1_dst0_min", 140, 0)
                self.controller.register_write("MyIngress.cluster1_dst0_max", 140, 255)
                self.controller.register_write("MyIngress.cluster1_dst1_min", 140, 0)
                self.controller.register_write("MyIngress.cluster1_dst1_max", 140, 255)
                self.controller.register_write("MyIngress.cluster1_dst2_min", 140, 0)
                self.controller.register_write("MyIngress.cluster1_dst2_max", 140, 127)
                self.controller.register_write("MyIngress.cluster1_dst3_min", 140, 0)
                self.controller.register_write("MyIngress.cluster1_dst3_max", 140, 127)

                self.controller.register_write("MyIngress.cluster2_dst0_min", 140, 0)
                self.controller.register_write("MyIngress.cluster2_dst0_max", 140, 255)
                self.controller.register_write("MyIngress.cluster2_dst1_min", 140, 0)
                self.controller.register_write("MyIngress.cluster2_dst1_max", 140, 255)
                self.controller.register_write("MyIngress.cluster2_dst2_min", 140, 0)
                self.controller.register_write("MyIngress.cluster2_dst2_max", 140, 127)
                self.controller.register_write("MyIngress.cluster2_dst3_min", 140, 128)
                self.controller.register_write("MyIngress.cluster2_dst3_max", 140, 255)

                self.controller.register_write("MyIngress.cluster3_dst0_min", 140, 0)
                self.controller.register_write("MyIngress.cluster3_dst0_max", 140, 255)
                self.controller.register_write("MyIngress.cluster3_dst1_min", 140, 0)
                self.controller.register_write("MyIngress.cluster3_dst1_max", 140, 255)
                self.controller.register_write("MyIngress.cluster3_dst2_min", 140, 128)
                self.controller.register_write("MyIngress.cluster3_dst2_max", 140, 255)
                self.controller.register_write("MyIngress.cluster3_dst3_min", 140, 0)
                self.controller.register_write("MyIngress.cluster3_dst3_max", 140, 127)

                self.controller.register_write("MyIngress.cluster4_dst0_min", 140, 0)
                self.controller.register_write("MyIngress.cluster4_dst0_max", 140, 255)
                self.controller.register_write("MyIngress.cluster4_dst1_min", 140, 0)
                self.controller.register_write("MyIngress.cluster4_dst1_max", 140, 255)
                self.controller.register_write("MyIngress.cluster4_dst2_min", 140, 128)
                self.controller.register_write("MyIngress.cluster4_dst2_max", 140, 255)
                self.controller.register_write("MyIngress.cluster4_dst3_min", 140, 128)
                self.controller.register_write("MyIngress.cluster4_dst3_max", 140, 255)

        # We set the initialization counter to 1 so that clusters are initialized
        self.controller.register_write("MyIngress.init_counter", 140, 1)
        self.controller.register_write("MyIngress.updateclusters_counter", 140, 0)
    ...
    def __init__(self, switch_name:str):
        ...
        try:
            ...
            self.controller.counter_reset("MyEgress.bytes_counter_malicious_egress")
            ...
            self.controller.counter_reset("MyEgress.bytes_counter_benign_egress")
